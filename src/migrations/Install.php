...
/**
 * craft-fields-vcs Install Migration
 *
...
class Install extends Migration
{
    ...
    // craftfieldsvcs_fields table
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%craftfieldsvcs_fields}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%craftfieldsvcs_fields}}',
                [
                    'id' => $this->primaryKey(),
    ...
    // craftfieldsvcs_fields table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%craftfieldsvcs_fields}}', 'siteId'),
            '{{%craftfieldsvcs_fields}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
    // craftfieldsvcs_fields table
        $this->dropTableIfExists('{{%craftfieldsvcs_fields}}');
    }
}
